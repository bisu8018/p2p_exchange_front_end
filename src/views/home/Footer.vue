<template>
  <v-footer
    ...
    align-center
  >
    <v-container fluid grid-list-xs style="max-width: 1200px;" pl-0 pr-0>
      <v-layout
        wrap
        row
        border-bottom
        ...
        <v-flex xs12 md3 text-md-left>
          <v-card flat>
            <v-card-text class="grey--text grey lighten-4">
              <p><img src="@/assets/img/logo_OTC.png"> </p>
            </v-card-text>
          </v-card>
        </v-flex>
        <!-- 카드 2 Support -->
        <v-flex xs12 md4 text-md-left>
          <v-card flat>
            <v-card-text class="grey--text grey lighten-4">
              <p>{{$str("support")}}</p>
              <a class="black--text" href="https://vuetifyjs.com" target="_blank"><p>{{$str("guides")}}</p></a>
              <a class="black--text" href="https://vuetifyjs.com" target="_blank"><p>{{$str("FAQ")}}</p></a>
              <a class="black--text" href="https://vuetifyjs.com" target="_blank"><p>{{$str("announcements")}}</p></a>
            </v-card-text>
          </v-card>
        </v-flex>
        <!-- 카드 3 Terms-->
        <v-flex xs12 md3 text-md-left>
          <v-card flat>
            <v-card-text class="grey--text grey lighten-4">
              ...
              <a class="black--text" href="https://vuetifyjs.com" target="_blank"><p>{{$str("fees")}}</p></a>

            </v-card-text>
          </v-card>
        </v-flex>
        <!-- 카드 4 Contact Us-->
        <v-flex xs12 md2 text-md-right  class="grey lighten-4">
          <v-card flat>
            <v-card-text class="grey--text grey lighten-4" >
              <p>{{$str("contact_Us")}}</p>
              <a class="black--text" href="https://vuetifyjs.com" target="_blank">support@allblab.com</a>
            </v-card-text>
          </v-card>
        </v-flex>
      </v-layout>
